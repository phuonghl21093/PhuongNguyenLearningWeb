!function (window, document, undefined) {
    var absPos = function (element) {
        ...
        if (offsetLeft = offsetTop = 0, element.offsetParent)do offsetLeft += element.offsetLeft, offsetTop += element.offsetTop; while (element = element.offsetParent);
    ...
    Circle.prototype = {
        constructor: Circle, update: function (value) {
