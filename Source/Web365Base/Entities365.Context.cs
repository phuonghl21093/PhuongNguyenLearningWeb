...
namespace Web365Base
{
    ...
    public partial class Entities365 : DbContext
    {
        ...
        public virtual DbSet<tblLayoutContent_Picture_Map> tblLayoutContent_Picture_Map { get; set; }
        public virtual DbSet<tblLayoutGroup> tblLayoutGroup { get; set; }
        ...
        public virtual DbSet<tempDelete> tempDelete { get; set; }
        ...
        public virtual ObjectResult<PRC_MenuByParentId_Result> PRC_MenuByParentId(string listID, Nullable<int> languageID)
        {
            var listIDParameter = listID != null ?
                new ObjectParameter("ListID", listID) :
                new ObjectParameter("ListID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PRC_MenuByParentId_Result>("PRC_MenuByParentId", listIDParameter, languageIDParameter);
        }
        ...
        public virtual int PRC_ResetPictureLayoutContent(Nullable<int> layoutContentID, string listID)
        {
            var layoutContentIDParameter = layoutContentID.HasValue ?
                new ObjectParameter("LayoutContentID", layoutContentID) :
                new ObjectParameter("LayoutContentID", typeof(int));
    
            var listIDParameter = listID != null ?
                new ObjectParameter("ListID", listID) :
                new ObjectParameter("ListID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PRC_ResetPictureLayoutContent", layoutContentIDParameter, listIDParameter);
        }
        ...
        public virtual int PRC_Video_GetVideoByType(Nullable<int> typeID, string typeAscii, Nullable<int> skip, Nullable<int> top, ObjectParameter total)
        {
            var typeIDParameter = typeID.HasValue ?
                new ObjectParameter("TypeID", typeID) :
                new ObjectParameter("TypeID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PRC_Video_GetVideoByType", typeIDParameter, typeAsciiParameter, skipParameter, topParameter, total);
        }
    
        public virtual int SQLNET_EvalResultSet()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SQLNET_EvalResultSet");
        }
    
        [DbFunction("Entities365", "SQLNET_EvalTVF_2")]
        public virtual IQueryable<SQLNET_EvalTVF_2_Result> SQLNET_EvalTVF_2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SQLNET_EvalTVF_2_Result>("[Entities365].[SQLNET_EvalTVF_2]()");
        }
    
        [DbFunction("Entities365", "SQLNET_EvalTVF_3")]
        public virtual IQueryable<SQLNET_EvalTVF_3_Result> SQLNET_EvalTVF_3()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SQLNET_EvalTVF_3_Result>("[Entities365].[SQLNET_EvalTVF_3]()");
        }
    
        [DbFunction("Entities365", "SQLNET_EvalTVF_4")]
        public virtual IQueryable<SQLNET_EvalTVF_4_Result> SQLNET_EvalTVF_4()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SQLNET_EvalTVF_4_Result>("[Entities365].[SQLNET_EvalTVF_4]()");
        }
    
        [DbFunction("Entities365", "SQLNET_EvalTVF_5")]
        public virtual IQueryable<SQLNET_EvalTVF_5_Result> SQLNET_EvalTVF_5()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SQLNET_EvalTVF_5_Result>("[Entities365].[SQLNET_EvalTVF_5]()");
        }
    
        [DbFunction("Entities365", "SQLNET_EvalTVF_String")]
        public virtual IQueryable<string> SQLNET_EvalTVF_String()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[Entities365].[SQLNET_EvalTVF_String]()");
        }
