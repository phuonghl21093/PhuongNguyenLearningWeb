  ...
  function ($routeProvider, $locationProvider) {
      $routeProvider.
        ...
        when('/banner', {
            ...
            templateUrl: '/Angular/Views/Admin/ImageBanner/index.html',
            controller: 'banner'
        }).
        when('/picture-type', {
        ...
        when('/layout-group', {
            title: 'Quản lý nhóm nội dung web',
            templateUrl: '/Angular/Views/Admin/LayoutGroup/index.html',
        ...
        when('/setting', {
            title: 'Thông tin cài đặt website',
            templateUrl: '/Angular/Views/Admin/Setting/index.html',
            controller: 'setting'
        }).
        when('/language', {
            title: 'Ngôn ngữ',
            templateUrl: '/Angular/Views/Admin/Language/index.html',
            controller: 'language'
        }).
        otherwise({
